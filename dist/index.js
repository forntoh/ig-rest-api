...
var ig = new _api.default(process && process.env && process.env.IG_API_KEY || "f201f8d7ff222f525a9d25a22b889125ec2c63ab", true); // Using promises

ig.login(process && process.env && process.env.IG_USERNAME || "forntoh", process && process.env && process.env.IG_USERNAME || "forntoh") // Response data is automatically
...
.catch(console.error); // Using async await
// try {
